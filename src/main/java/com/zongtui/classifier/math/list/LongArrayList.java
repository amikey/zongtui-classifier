...
import com.zongtui.classifier.math.function.LongProcedure;
...
public class LongArrayList extends AbstractLongList implements Cloneable {
  ...
  public int binarySearchFromTo(long key, int from, int to) {
    return com.zongtui.classifier.math.BinarySearch.binarySearchFromTo(elements, key, from, to);
  }
  ...
  public void ensureCapacity(int minCapacity) {
    elements = com.zongtui.classifier.math.Arrays.ensureCapacity(elements, minCapacity);
  }
  ...
  public boolean removeAll(AbstractLongList other) {
    ...
    */
    ...
    if ((N + M) * com.zongtui.classifier.collections.Arithmetic.log2(N) < M * N) {
  ...
  public void trimToSize() {
    elements = com.zongtui.classifier.math.Arrays.trimToCapacity(elements, size());
  }
}
